...
export default function FrResultsContent() {
  ...
  useEffect(() => {
    trackFbq('track', 'ViewContent', {
      content_name: 'Résultats Score QI',
  ...
  function downloadScoreCard() {
    ...
    link.download = `brainscale-qi-${score}.png`;
    link.href = canvas.toDataURL("image/png");
    link.click();
  }

  function copyLink() {
    navigator.clipboard.writeText("https://www.brainscale.app/fr/test");
    setCopied(true);
    ...
    <div style={{ backgroundColor: "#FAF8F5", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)", paddingBottom: "88px" }}>
      ...
      <header style={{ backgroundColor: "#FAF8F5", borderBottom: "1px solid #E8E5DF", padding: "0 24px" }}>
        <div style={{ maxWidth: "760px", margin: "0 auto", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/fr" style={{ fontFamily: "var(--font-display, serif)", fontSize: "18px", fontWeight: 600, letterSpacing: "-0.03em", color: "#1A1916", textDecoration: "none" }}>
      ...
      <main style={{ maxWidth: "680px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: "20px", marginBottom: "16px", flexWrap: "wrap" }}>
            ...
            <div style={{ paddingBottom: "10px" }}>
              ...
              <div style={{ fontSize: "13px", color: "#99958C" }}>mondial</div>
            </div>
          </div>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "24px", marginBottom: "24px" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "8px" }}>
            <a href={`https://twitter.com/intent/tweet?text=Je%20viens%20de%20scorer%20${score}%20au%20test%20QI%20BrainScale.%20Tu%20peux%20faire%20mieux%20%3F&url=https%3A%2F%2Fwww.brainscale.app%2Ffr%2Ftest`} target="_blank" rel="noopener noreferrer"
            ...
            <a href={`https://wa.me/?text=Je%20viens%20de%20scorer%20${score}%20au%20test%20QI%20BrainScale.%20Tu%20peux%20faire%20mieux%20%3F%20https%3A%2F%2Fwww.brainscale.app%2Ffr%2Ftest`} target="_blank" rel="noopener noreferrer"
        ...
        <div style={{ display: "flex", borderRadius: "12px", border: "1px solid #E8E5DF", backgroundColor: "#fff", overflow: "hidden", marginBottom: "16px" }}>
          <div style={{ flex: "1.5", padding: "20px 20px", borderRight: "1px solid #E8E5DF", backgroundColor: "#FBF0EB" }}>
            ...
            <div style={{ fontSize: "11px", color: "#99958C", marginTop: "2px" }}>mondial</div>
          </div>
          ...
          <div style={{ flex: "1", padding: "20px 14px" }}>
            ...
            <div style={{ fontSize: "12px", color: "#1A1916", fontWeight: 600, marginTop: "5px" }}>Rang mondial</div>
          </div>
        </div>

        {/* BREAKDOWN */}
        <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "28px 32px", marginBottom: "16px" }}>
          <h3 style={{ fontFamily: "var(--font-display, serif)", fontSize: "17px", fontWeight: 500, color: "#1A1916", marginBottom: "24px" }}>Performance par catégorie</h3>
          {breakdown.map((b) => (
            <div key={b.label} style={{ marginBottom: "18px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", marginBottom: "8px" }}>
                <span style={{ color: "#1A1916", fontWeight: 500 }}>{b.label}</span>
                <span style={{ color: "#C96442", fontWeight: 600 }}>{b.score}e percentile</span>
              </div>
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <Link href={`/fr/iq-score/${score}`} style={{ fontSize: "13px", color: "#C96442", textDecoration: "none", fontWeight: 600 }}>
        ...
        <div style={{ position: "relative", borderRadius: "16px", overflow: "hidden", marginBottom: "28px" }}>
          <div className="bs-blur-bg" style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", padding: "32px", opacity: 0.12, userSelect: "none", pointerEvents: "none" }} aria-hidden="true">
            <h3 style={{ fontFamily: "var(--font-display, serif)", fontSize: "17px", color: "#1A1916", marginBottom: "16px" }}>Profil cognitif détaillé</h3>
        ...
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", paddingTop: "4px" }}>
          <Link href="/fr/test" style={{ backgroundColor: "#C96442", color: "#fff", padding: "14px 32px", borderRadius: "8px", fontSize: "14px", fontWeight: 600, textDecoration: "none" }}>
            Refaire le test
          </Link>
          <Link href="/fr" style={{ backgroundColor: "#fff", color: "#5C5A52", padding: "14px 32px", borderRadius: "8px", fontSize: "14px", fontWeight: 500, textDecoration: "none", border: "1px solid #E8E5DF" }}>
            Accueil
          </Link>
        </div>
