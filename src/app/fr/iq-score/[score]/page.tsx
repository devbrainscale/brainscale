...
function getClassification(iq: number): { label: string; color: string; band: string } {
  if (iq >= 130) return { label: "Surdoué", color: "#C96442", band: "Top 2 %" };
  if (iq >= 120) return { label: "Supérieur", color: "#B5572F", band: "Top 9 %" };
  if (iq >= 110) return { label: "Au-dessus de la moyenne", color: "#5248D0", band: "Top 25 %" };
  if (iq >= 90)  return { label: "Moyen", color: "#D4835E", band: "Milieu 50 %" };
  if (iq >= 80)  return { label: "Sous la moyenne", color: "#99958C", band: "Bas 25 %" };
    ...
    <div style={{ backgroundColor: "#FAF8F5", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <header style={{ backgroundColor: "#FAF8F5", borderBottom: "1px solid #E8E5DF", padding: "0 24px" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <Link href="/fr/test" style={{ backgroundColor: "#C96442", color: "#fff", padding: "8px 18px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
            Passer le test →
          </Link>
        </div>
      </header>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <nav style={{ fontSize: "12px", color: "#99958C", marginBottom: "32px" }}>
          ...
          <Link href="/fr/iq-score/100" style={{ color: "#99958C", textDecoration: "none" }}>Scores QI</Link>
          <span style={{ margin: "0 8px" }}>›</span>
          <span style={{ color: "#1A1916" }}>QI {iq}</span>
        </nav>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "28px 32px", marginBottom: "16px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            <span style={{ fontSize: "13px", fontWeight: 600, color: "#1A1916" }}>Position sur l'échelle de QI</span>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "32px", marginBottom: "16px" }}>
          ...
          {[
            ...
            <div key={row.range} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 16px", borderRadius: "8px", marginBottom: "4px", backgroundColor: row.current ? "#FBF0EB" : "transparent", border: row.current ? "1px solid #E8C4B4" : "1px solid transparent" }}>
              ...
              {row.current && <span style={{ marginLeft: "8px", fontSize: "11px", fontWeight: 700, color: "#C96442" }}>← Vous</span>}
            </div>
          ))}
        </div>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "28px 32px", marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
            {related.map(s => (
              <Link key={s} href={`/fr/iq-score/${s}`} style={{ backgroundColor: "#FAF8F5", border: "1px solid #E8E5DF", color: "#C96442", padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
                QI {s}
              </Link>
            ))}
          </div>
        ...
        <div style={{ backgroundColor: "#1A1916", borderRadius: "16px", padding: "40px 32px", textAlign: "center" }}>
          ...
          <Link href="/fr/test" style={{ display: "inline-block", backgroundColor: "#C96442", color: "#fff", padding: "16px 40px", borderRadius: "8px", fontSize: "15px", fontWeight: 600, textDecoration: "none" }}>
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: "1px solid #E8E5DF", padding: "24px", textAlign: "center" }}>
        <p style={{ fontSize: "12px", color: "#99958C" }}>
          <Link href="/fr" style={{ color: "#99958C", textDecoration: "none" }}>BrainScale</Link>
          {" · "}
          <Link href="/privacy" style={{ color: "#99958C", textDecoration: "none" }}>Confidentialité</Link>
          {" · "}
          <Link href="/terms" style={{ color: "#99958C", textDecoration: "none" }}>Conditions</Link>
