  ...
  return (
    <div style={{ backgroundColor: "#FAF8F5", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "64px 24px" }}>
        ...
        <Link href={`/fr/blog/${articles[0].slug}`} style={{ textDecoration: "none", display: "block", marginBottom: "32px" }}>
          <div className="blog-featured" style={{ backgroundColor: "#FBF0EB", border: "1px solid #E8C4B4", borderRadius: "24px", padding: "48px", transition: "transform 0.15s ease, box-shadow 0.15s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
              ...
              <span style={{ fontSize: "13px", color: "#99958C" }}>{articles[0].readingTime} de lecture</span>
            </div>
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(22px, 3vw, 32px)", fontWeight: 400, color: "#1A1916", marginBottom: "12px", lineHeight: 1.3 }}>
              {articles[0].title}
            </h2>
            <p style={{ fontSize: "16px", color: "#5C5A52", lineHeight: 1.6, marginBottom: "24px" }}>
              {articles[0].excerpt}
            </p>
            <span style={{ color: "#C96442", fontWeight: 600, fontSize: "14px" }}>Lire l&apos;article →</span>
          </div>
        </Link>
          ...
          {articles.slice(1).map((article) => (
            <Link key={article.slug} href={`/fr/blog/${article.slug}`} style={{ textDecoration: "none" }}>
              <div className="blog-card" style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "20px", padding: "28px", height: "100%", transition: "transform 0.15s ease, box-shadow 0.15s ease" }}>
                ...
                <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "18px", fontWeight: 400, color: "#1A1916", marginBottom: "10px", lineHeight: 1.4 }}>
                  {article.title}
                </h2>
                <p style={{ fontSize: "14px", color: "#99958C", lineHeight: 1.6, marginBottom: "20px" }}>
                  {article.excerpt}
                </p>
                <span style={{ color: "#C96442", fontWeight: 600, fontSize: "13px" }}>Lire →</span>
              </div>
            </Link>
          ))}
        </div>
        ...
        {/* CTA */}
        <div style={{ textAlign: "center", marginTop: "64px", padding: "48px", backgroundColor: "#fff", borderRadius: "24px", border: "1px solid #E8E5DF" }}>
          <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "28px", fontWeight: 300, color: "#1A1916", marginBottom: "12px" }}>
            Prêt à connaître votre score ?
          </h2>
          <p style={{ fontSize: "15px", color: "#99958C", marginBottom: "24px" }}>40 questions · Résultats instantanés · 100 % gratuit</p>
          <Link href="/fr/test" style={{ backgroundColor: "#C96442", color: "#fff", padding: "16px 40px", borderRadius: "999px", fontSize: "15px", fontWeight: 700, textDecoration: "none", boxShadow: "0 6px 24px rgba(201,100,66,0.35)", display: "inline-block" }}>
