      ...
      <div style={{ backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "24px", padding: "56px 48px", maxWidth: "480px", width: "100%", textAlign: "center", boxShadow: "0 4px 24px rgba(26,25,22,0.08)" }}>
        <div style={{ marginBottom: "24px", display: "flex", justifyContent: "center" }}>
          <svg width="64" height="64" viewBox="0 0 64 64" fill="none" xmlns="http://www.w3.org/2000/svg">
            <circle cx="32" cy="32" r="32" fill="#FAF8F5"/>
            <circle cx="32" cy="32" r="24" fill="#E8E5DF"/>
            <path d="M38 26H28a4 4 0 0 0-4 4v4a4 4 0 0 0 4 4h2l-2 4 6-4h4a4 4 0 0 0 4-4v-4a4 4 0 0 0-4-4z" fill="none" stroke="#99958C" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            <line x1="29" y1="31" x2="35" y2="31" stroke="#99958C" strokeWidth="2" strokeLinecap="round"/>
            <line x1="29" y1="34" x2="33" y2="34" stroke="#99958C" strokeWidth="2" strokeLinecap="round"/>
          </svg>
        </div>
        ...
        <Link href="/results" style={{ backgroundColor: "#C96442", color: "#fff", padding: "14px 32px", borderRadius: "999px", fontSize: "14px", fontWeight: 700, textDecoration: "none", display: "inline-block" }}>
          Back to my results
        </Link>
      </div>
    </div>
