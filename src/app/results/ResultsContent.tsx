    ...
    <div style={{ backgroundColor: "#F7F6F2", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)", paddingBottom: "88px" }}>
      ...
      <main style={{ maxWidth: "680px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "16px" }}>
          {[
            { value: `${percentile}%`, label: "Percentile", sub: "world population" },
            { value: `${correct}/${total}`, label: "Correct answers", sub: `${accuracy}% accuracy` },
            { value: score >= 130 ? "Top 2%" : score >= 120 ? "Top 9%" : score >= 115 ? "Top 16%" : score >= 110 ? "Top 25%" : score >= 100 ? "Top 50%" : score >= 90 ? "Bottom 25%" : "Bottom 16%", label: "World rank", sub: "" },
          ].map((s) => (
