    ...
    <div style={{ backgroundColor: "#F4F2EC", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)", paddingBottom: "88px" }}>
      ...
      <header style={{ backgroundColor: "#F4F2EC", borderBottom: "1px solid #DDD9CF", padding: "0 24px" }}>
        <div style={{ maxWidth: "680px", margin: "0 auto", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <Link href="/" style={{ fontFamily: "var(--font-display, serif)", fontSize: "18px", fontWeight: 600, letterSpacing: "-0.03em", color: "#1C1B13", textDecoration: "none" }}>
      ...
      <main style={{ maxWidth: "680px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ marginBottom: "40px" }}>
          ...
          <div style={{ display: "flex", alignItems: "flex-end", gap: "20px", marginBottom: "16px", flexWrap: "wrap" }}>
            ...
            <div style={{ paddingBottom: "10px" }}>
              ...
              <div style={{ fontSize: "13px", color: "#978F80" }}>worldwide</div>
            </div>
          </div>
        ...
        {!submitted && !skipped ? (
          <div style={{ backgroundColor: "#ECEBF8", border: "1px solid #B9B8E4", borderRadius: "16px", padding: "32px", marginBottom: "20px", textAlign: "center" }}>
            ...
            <div style={{ display: "flex", alignItems: "flex-start", gap: "10px", maxWidth: "440px", margin: "12px auto 0", textAlign: "left" }}>
              <input type="checkbox" id="gdpr-en" checked={gdprConsent} onChange={(e) => setGdprConsent(e.target.checked)} style={{ marginTop: "2px", accentColor: "#3B35B5", flexShrink: 0, cursor: "pointer" }} />
              <label htmlFor="gdpr-en" style={{ fontSize: "12px", color: "#5A5849", lineHeight: 1.5, cursor: "pointer" }}>
                I agree to receive my results by email. Unsubscribe at any time.{" "}
                <a href="/privacy" style={{ color: "#3B35B5", textDecoration: "underline" }}>Privacy Policy</a>.
              </label>
            </div>
          ...
          <div style={{ backgroundColor: "#ECEBF8", border: "1px solid #B9B8E4", borderRadius: "12px", padding: "16px 24px", marginBottom: "20px", textAlign: "center" }}>
            <p style={{ fontSize: "14px", color: "#3B35B5", fontWeight: 600 }}>Report sent — check your inbox.</p>
          </div>
        ) : null}
        ...
        <div style={{ display: "flex", borderRadius: "12px", border: "1px solid #DDD9CF", backgroundColor: "#fff", overflow: "hidden", marginBottom: "16px" }}>
          <div style={{ flex: "1.5", padding: "20px 20px", borderRight: "1px solid #DDD9CF", backgroundColor: "#ECEBF8" }}>
            ...
            <div style={{ fontSize: "11px", color: "#978F80", marginTop: "2px" }}>worldwide</div>
          </div>
          ...
          <div style={{ flex: "1", padding: "20px 14px" }}>
            ...
            <div style={{ fontSize: "12px", color: "#1C1B13", fontWeight: 600, marginTop: "5px" }}>World rank</div>
          </div>
        </div>

        {/* BREAKDOWN */}
        <div style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "16px", padding: "28px 32px", marginBottom: "16px" }}>
          <h3 style={{ fontFamily: "var(--font-display, serif)", fontSize: "17px", fontWeight: 500, color: "#1C1B13", marginBottom: "24px" }}>Performance by category</h3>
          {breakdown.map((b) => (
            <div key={b.label} style={{ marginBottom: "18px" }}>
              <div style={{ display: "flex", justifyContent: "space-between", fontSize: "13px", marginBottom: "8px" }}>
                <span style={{ color: "#1C1B13", fontWeight: 500 }}>{b.label}</span>
                <span style={{ color: "#3B35B5", fontWeight: 600 }}>{b.score}th percentile</span>
              </div>
        ...
        <div style={{ textAlign: "center", marginBottom: "16px" }}>
          <Link href={`/iq-score/${score}`} style={{ fontSize: "13px", color: "#3B35B5", textDecoration: "none", fontWeight: 600 }}>
        ...
        <div style={{ position: "relative", borderRadius: "16px", overflow: "hidden", marginBottom: "28px" }}>
          <div className="bs-blur-bg" style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", padding: "32px", opacity: 0.12, userSelect: "none", pointerEvents: "none" }} aria-hidden="true">
            <h3 style={{ fontFamily: "var(--font-display, serif)", fontSize: "17px", color: "#1C1B13", marginBottom: "16px" }}>Detailed cognitive profile</h3>
          ...
          <div className="bs-overlay" style={{ position: "absolute", inset: 0, backgroundColor: "#F4F2EC", display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "flex-start", padding: "28px 24px", overflowY: "auto" }}>
            <p style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "2px", color: "#3B35B5", textTransform: "uppercase", marginBottom: "8px" }}>Unlock your results</p>
            ...
            <div style={{ display: "flex", gap: "12px", width: "100%", maxWidth: "480px", flexWrap: "wrap", justifyContent: "center" }}>
              <div style={{ flex: "1 1 170px", backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "12px", padding: "20px 16px", textAlign: "center" }}>
                <p style={{ fontSize: "10px", fontWeight: 700, color: "#978F80", letterSpacing: "1.5px", textTransform: "uppercase", marginBottom: "8px" }}>Essential</p>
              ...
              <div style={{ flex: "1 1 170px", backgroundColor: "#3B35B5", borderRadius: "12px", padding: "20px 16px", textAlign: "center", position: "relative" }}>
                ...
                <div style={{ fontSize: "12px", color: "rgba(255,255,255,0.82)", lineHeight: 2, marginBottom: "16px", textAlign: "left" }}>
                  ...
                  <div>✓ Cognitive certificate</div>
                  <div>✓ Instant delivery</div>
                  <div style={{ color: "#B9B8E4" }}>✓ 30-day training protocol</div>
                  <div style={{ color: "#B9B8E4" }}>✓ LinkedIn badge</div>
                </div>
            ...
            <p style={{ fontSize: "11px", color: "#978F80", marginTop: "14px" }}>Secure payment · Instant delivery</p>
          </div>
        </div>

        {/* ACTIONS */}
        <div style={{ display: "flex", gap: "12px", justifyContent: "center", flexWrap: "wrap", paddingTop: "4px" }}>
          <Link href="/test" style={{ backgroundColor: "#3B35B5", color: "#fff", padding: "14px 32px", borderRadius: "8px", fontSize: "14px", fontWeight: 600, textDecoration: "none" }}>
            Retake the test
          </Link>
          <Link href="/" style={{ backgroundColor: "#fff", color: "#5A5849", padding: "14px 32px", borderRadius: "8px", fontSize: "14px", fontWeight: 500, textDecoration: "none", border: "1px solid #DDD9CF" }}>
            Home
          </Link>
        </div>
      ...
      <div style={{ position: "fixed", bottom: 0, left: 0, right: 0, backgroundColor: "#F4F2EC", borderTop: "1px solid #DDD9CF", padding: "12px 16px", zIndex: 100 }}>
        <div className="bs-sticky">
          <span className="bs-sticky-label"><strong style={{ color: "#1C1B13" }}>Unlock your report</strong></span>
