      ...
      <main style={{ maxWidth: "760px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
            ...
            <a href={`https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fwww.brainscale.app%2Ftest`} target="_blank" rel="noopener noreferrer"
            ...
            <button onClick={() => navigator.clipboard.writeText("https://www.brainscale.app/test")}
