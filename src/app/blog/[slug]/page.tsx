    ...
    <div style={{ backgroundColor: "#FAF8F5", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px", fontSize: "13px", color: "#99958C", marginBottom: "32px" }}>
          ...
          <span>›</span>
          <Link href="/blog" style={{ color: "#99958C", textDecoration: "none" }}>Blog</Link>
          <span>›</span>
        ...
        <div style={{ marginBottom: "48px" }}>
          <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
            ...
            <span style={{ fontSize: "13px", color: "#99958C" }}>{article.readingTime} read</span>
        ...
        {otherArticles.length > 0 && (
          <div style={{ marginTop: "64px" }}>
            ...
            <div style={{ display: "grid", gap: "16px" }}>
              {otherArticles.map((a) => (
                <Link key={a.slug} href={`/blog/${a.slug}`} style={{ textDecoration: "none", display: "flex", alignItems: "center", justifyContent: "space-between", gap: "16px", backgroundColor: "#fff", border: "1px solid #E8E5DF", borderRadius: "16px", padding: "20px 24px" }}>
                  <div>
      ...
      <footer style={{ padding: "40px 24px", textAlign: "center", borderTop: "1px solid #E8E5DF" }}>
        <div style={{ display: "flex", justifyContent: "center", gap: "24px", marginBottom: "12px", flexWrap: "wrap" }}>
          <Link href="/" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>Home</Link>
          <Link href="/blog" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>Blog</Link>
          <Link href="/test" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>IQ Test</Link>
          <Link href="/privacy" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>Privacy</Link>
          <Link href="/terms" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>Terms</Link>
          <Link href="/fr/blog" style={{ fontSize: "13px", color: "#99958C", textDecoration: "none" }}>Français</Link>
        </div>
      ...
      <style>{`
        ...
        .article-content h2 { font-family: var(--font-display, serif); font-size: clamp(20px, 3.5vw, 26px); font-weight: 400; color: #1A1916; margin: 48px 0 16px; line-height: 1.3; }
        .article-content h3 { font-family: var(--font-display, serif); font-size: clamp(17px, 3vw, 20px); font-weight: 400; color: #1A1916; margin: 32px 0 12px; }
