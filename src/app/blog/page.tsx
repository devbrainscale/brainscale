    ...
    <div style={{ backgroundColor: "#F7F6F2", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "64px 24px" }}>
        ...
        <Link href={`/blog/${articles[0].slug}`} style={{ textDecoration: "none", display: "block", marginBottom: "32px" }}>
          <div className="blog-featured" style={{ backgroundColor: "#EEF2FF", border: "1px solid #C7D2FE", borderRadius: "24px", padding: "48px", transition: "transform 0.15s ease, box-shadow 0.15s ease" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px", marginBottom: "20px" }}>
              ...
              <span style={{ fontSize: "13px", color: "#9896A8" }}>{articles[0].readingTime} read</span>
            </div>
        ...
        <div style={{ textAlign: "center", marginTop: "64px", padding: "48px", backgroundColor: "#fff", borderRadius: "24px", border: "1px solid #E8E5DC" }}>
          ...
          <p style={{ fontSize: "15px", color: "#9896A8", marginBottom: "24px" }}>40 questions · Instant results · 100% free</p>
