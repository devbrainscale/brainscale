...
function SampleQuestion() {
  ...
  return (
    <div style={{ backgroundColor: "#E9E6DC", border: "1px solid #DDD9CF", borderRadius: "24px", padding: "40px" }}>
      ...
      {selected === null && (
        <p style={{ fontSize: "12px", color: "#978F80", marginTop: "16px" }}>Try it — click an answer</p>
      )}
      {selected !== null && selected === correct && (
        <p style={{ fontSize: "13px", color: "#3B35B5", fontWeight: 600, marginTop: "16px" }}>✓ Correct — cyclic rotation pattern.</p>
      )}
      {selected !== null && selected !== correct && (
        <p style={{ fontSize: "13px", color: "#978F80", fontWeight: 500, marginTop: "16px" }}>Not quite — the answer is ● (cyclic rotation).</p>
      )}
    </div>
  );
}
    ...
    <div style={{ backgroundColor: "#F4F2EC", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <nav style={{ backgroundColor: "#F4F2EC", borderBottom: "1px solid #DDD9CF", position: "sticky", top: 0, zIndex: 50 }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "0 24px", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          <span style={{ fontFamily: "var(--font-display, serif)", fontSize: "20px", fontWeight: 600, letterSpacing: "-0.03em", color: "#1C1B13" }}>
            Brain<span style={{ color: "#3B35B5" }}>Scale</span>
          </span>
          <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
            <Link href="/blog" style={{ fontSize: "13px", color: "#978F80", textDecoration: "none", letterSpacing: "0.01em" }}>Blog</Link>
            <div style={{ display: "flex", alignItems: "center", gap: "6px" }}>
              <span style={{ fontSize: "13px", color: "#3B35B5", fontWeight: 600 }}>EN</span>
              <span style={{ fontSize: "11px", color: "#C8C4B8" }}>·</span>
              <Link href="/fr" style={{ fontSize: "13px", color: "#978F80", textDecoration: "none" }}>FR</Link>
            </div>
            <Link href="/test" style={{ backgroundColor: "#1C1B13", color: "#F4F2EC", padding: "10px 22px", borderRadius: "999px", fontSize: "13px", fontWeight: 600, textDecoration: "none", letterSpacing: "0.01em" }}>
              Start Test
            </Link>
          </div>
        </div>
        ...
        <div className="bs-hero-grid" style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "56px", alignItems: "center" }}>
          ...
          <div>
            ...
            <h1 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(44px, 5.5vw, 72px)", fontWeight: 400, lineHeight: 1.05, letterSpacing: "-0.03em", color: "#1C1B13", marginBottom: "24px" }}>
              Discover your{" "}
              <em style={{ color: "#3B35B5", fontStyle: "italic" }}>IQ score</em>
              {" "}in 40 minutes
            </h1>
            ...
            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap" }}>
              <Link href="/test" style={{ backgroundColor: "#3B35B5", color: "#fff", padding: "14px 30px", borderRadius: "999px", fontSize: "15px", fontWeight: 600, textDecoration: "none", letterSpacing: "0.01em", boxShadow: "0 4px 20px rgba(59,53,181,0.30)" }}>
                Test My IQ — Free
              </Link>
              <a href="#how-it-works" style={{ color: "#5A5849", padding: "14px 26px", borderRadius: "999px", fontSize: "15px", fontWeight: 500, textDecoration: "none", border: "1px solid #C8C4B8" }}>
                How it works →
              </a>
            </div>
          ...
          <div className="bs-hero-card" style={{ backgroundColor: "#E9E6DC", border: "1px solid #DDD9CF", borderRadius: "24px", padding: "36px 32px" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "28px" }}>
              <span style={{ display: "inline-block", backgroundColor: "#3B35B5", color: "#fff", padding: "4px 14px", borderRadius: "999px", fontSize: "11px", fontWeight: 700, letterSpacing: "0.02em" }}>Superior</span>
              <span style={{ fontSize: "12px", color: "#978F80" }}>Top 9% worldwide</span>
            </div>
      ...
      <section style={{ padding: "0 24px 64px" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", backgroundColor: "#E9E6DC", borderRadius: "24px", padding: "48px 40px", textAlign: "center" }}>
          ...
          <p style={{ fontSize: "13px", color: "#978F80", marginBottom: "32px", letterSpacing: "0.01em" }}>World average: 100 · Standard deviation: 15</p>
          ...
          <div className="bs-bell-legend" style={{ display: "grid", gridTemplateColumns: "repeat(5, 1fr)", gap: "5px", marginTop: "20px" }}>
            {[
              { range: "< 90",    label: "Below Avg",  pct: "25%", bg: "rgba(59,53,181,0.06)", text: "#978F80", sub: "#B0AEC0" },
              { range: "90–109",  label: "Average",    pct: "50%", bg: "rgba(59,53,181,0.15)", text: "#3B35B5", sub: "#5A5849" },
              { range: "110–119", label: "Above Avg",  pct: "16%", bg: "rgba(59,53,181,0.32)", text: "#2620A0", sub: "#3028A8" },
              { range: "120–129", label: "Superior",   pct: "7%",  bg: "rgba(59,53,181,0.52)", text: "#fff",    sub: "rgba(255,255,255,0.78)" },
              { range: "≥ 130",   label: "Gifted",     pct: "2%",  bg: "rgba(59,53,181,0.72)", text: "#fff",    sub: "rgba(255,255,255,0.78)" },
            ].map((z) => (
        ...
        <div className="bs-method-grid" style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", alignItems: "start", gap: "80px" }}>
          ...
          <div style={{ paddingTop: "8px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 300, letterSpacing: "-0.02em", lineHeight: 1.15, color: "#1C1B13", marginBottom: "20px" }}>
              A <em style={{ color: "#3B35B5", fontStyle: "italic" }}>scientific</em> methodology
            </h2>
        ...
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "52px", flexWrap: "wrap", gap: "20px" }}>
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 300, letterSpacing: "-0.02em", color: "#1C1B13" }}>
              What the test <em style={{ color: "#3B35B5", fontStyle: "italic" }}>measures</em>
            </h2>
            <Link href="/test" style={{ fontSize: "14px", color: "#3B35B5", fontWeight: 600, textDecoration: "none", letterSpacing: "0.01em", flexShrink: 0 }}>
              Take the test →
            </Link>
          </div>
      ...
      <section style={{ padding: "108px 24px", backgroundColor: "#E9E6DC" }}>
        <div className="bs-privacy-grid" style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", alignItems: "center" }}>
          ...
          <div>
            <div style={{ fontSize: "10px", fontWeight: 700, letterSpacing: "0.12em", color: "#3B35B5", textTransform: "uppercase" as const, marginBottom: "18px" }}>Privacy</div>
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 300, letterSpacing: "-0.02em", color: "#1C1B13", marginBottom: "28px", lineHeight: 1.15 }}>
              Your privacy,{" "}
              <em style={{ color: "#3B35B5", fontStyle: "italic" }}>our priority</em>
            </h2>
            ...
            <Link href="/test" style={{ display: "inline-block", backgroundColor: "#1C1B13", color: "#F4F2EC", padding: "14px 28px", borderRadius: "999px", fontSize: "14px", fontWeight: 600, textDecoration: "none", letterSpacing: "0.01em" }}>
        ...
        <div style={{ maxWidth: "640px", margin: "0 auto" }}>
          <div style={{ textAlign: "center", marginBottom: "56px" }}>
            ...
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 300, letterSpacing: "-0.02em", color: "#1C1B13", lineHeight: 1.15 }}>
              Frequently asked <em style={{ color: "#3B35B5", fontStyle: "italic" }}>questions</em>
            </h2>
          </div>
      ...
      <section style={{ padding: "108px 24px", backgroundColor: "#E9E6DC" }}>
        <div style={{ maxWidth: "1100px", margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-end", marginBottom: "48px", flexWrap: "wrap", gap: "20px" }}>
            <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(26px, 3.5vw, 42px)", fontWeight: 300, letterSpacing: "-0.02em", color: "#1C1B13" }}>
              Real scores, real <em style={{ color: "#3B35B5", fontStyle: "italic" }}>people</em>
            </h2>
            <p style={{ fontSize: "13px", color: "#978F80", letterSpacing: "0.01em" }}>847,000+ tests completed worldwide</p>
          </div>
          ...
          <div className="bs-testi-featured" style={{ display: "grid", gap: "48px", alignItems: "center", backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "20px", padding: "40px", marginBottom: "16px" }}>
            <div className="bs-testi-score-border" style={{ textAlign: "center", borderRight: "1px solid #DDD9CF", paddingRight: "48px" }}>
              <div style={{ fontFamily: "var(--font-display, serif)", fontSize: "80px", fontWeight: 300, letterSpacing: "-0.04em", color: "#1C1B13", lineHeight: 1 }}>134</div>
              <div style={{ display: "inline-block", backgroundColor: "#3B35B5", color: "#fff", padding: "4px 14px", borderRadius: "999px", fontSize: "11px", fontWeight: 700, marginTop: "10px" }}>Gifted</div>
            ...
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                <div style={{ width: "34px", height: "34px", borderRadius: "50%", backgroundColor: "#ECEBF8", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "11px", fontWeight: 700, color: "#3B35B5", flexShrink: 0 }}>JT</div>
                <div>
                  <div style={{ fontSize: "13px", fontWeight: 600, color: "#1C1B13" }}>James T.</div>
                  <div style={{ fontSize: "12px", color: "#978F80" }}>London, UK</div>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bs-testi-pair" style={{ display: "grid", gap: "16px" }}>
            {[
              {
                score: 121, label: "Superior", labelColor: "#3028A8",
              ...
              {
                score: 114, label: "Above Avg", labelColor: "#3028A8",
              ...
              <div key={t.name} style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "20px", padding: "28px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "16px", marginBottom: "16px" }}>
                  ...
                  <div>
                    ...
                    <div style={{ fontSize: "11px", color: "#978F80" }}>IQ Score</div>
                  </div>
                </div>
      ...
      <section style={{ margin: "0 24px 24px", borderRadius: "24px", backgroundColor: "#13120D", padding: "100px 24px", textAlign: "center" }}>
        <div style={{ maxWidth: "560px", margin: "0 auto" }}>
          ...
          <h2 style={{ fontFamily: "var(--font-display, serif)", fontSize: "clamp(30px, 4.5vw, 52px)", fontWeight: 300, letterSpacing: "-0.03em", color: "#fff", marginBottom: "20px", lineHeight: 1.1 }}>
            Ready to discover{" "}
            <em style={{ color: "#8578CC", fontStyle: "italic" }}>your potential?</em>
          </h2>
          ...
          <Link href="/test" style={{ display: "inline-block", backgroundColor: "#fff", color: "#1C1B13", padding: "16px 40px", borderRadius: "999px", fontSize: "15px", fontWeight: 600, textDecoration: "none", letterSpacing: "0.01em" }}>
            Start Now — It&apos;s Free
          </Link>
        </div>
      </section>
      ...
      <footer style={{ padding: "48px 24px" }}>
        <div className="bs-footer-grid" style={{ maxWidth: "1100px", margin: "0 auto", display: "grid", alignItems: "start" }}>
          <div>
            <Link href="/" style={{ fontFamily: "var(--font-display, serif)", fontSize: "18px", fontWeight: 600, letterSpacing: "-0.03em", color: "#1C1B13", textDecoration: "none", display: "inline-block", marginBottom: "10px" }}>
              Brain<span style={{ color: "#3B35B5" }}>Scale</span>
            </Link>
            <p style={{ fontSize: "13px", color: "#978F80", lineHeight: 1.6 }}>Free psychometric IQ test.<br />Trusted worldwide since 2024.</p>
          </div>
          <div style={{ display: "flex", gap: "32px", flexWrap: "wrap", alignItems: "flex-start", justifyContent: "flex-end" }}>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <Link href="/blog" style={{ fontSize: "13px", color: "#5A5849", textDecoration: "none" }}>Blog</Link>
              <Link href="/fr" style={{ fontSize: "13px", color: "#5A5849", textDecoration: "none" }}>Français</Link>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              <Link href="/privacy" style={{ fontSize: "13px", color: "#5A5849", textDecoration: "none" }}>Privacy Policy</Link>
              <Link href="/terms" style={{ fontSize: "13px", color: "#5A5849", textDecoration: "none" }}>Terms of Service</Link>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
