export const metadata = {
  ...
  description: "Terms and conditions for using the BrainScale cognitive assessment platform.",
};
      ...
      <main className="mx-auto max-w-6xl px-4 py-14 sm:px-6 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <p className="mt-6 text-sm leading-7 text-[#475569]">
            BrainScale is provided as-is for educational and entertainment purposes. For questions, email{" "}
            <a
