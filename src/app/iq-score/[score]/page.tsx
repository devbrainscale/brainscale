...
function getClassification(iq: number): { label: string; color: string; band: string } {
  if (iq >= 130) return { label: "Gifted", color: "#3B35B5", band: "Top 2%" };
  if (iq >= 120) return { label: "Superior", color: "#3028A8", band: "Top 9%" };
  if (iq >= 110) return { label: "Above Average", color: "#5248D0", band: "Top 25%" };
  if (iq >= 90)  return { label: "Average", color: "#7068D8", band: "Middle 50%" };
  if (iq >= 80)  return { label: "Below Average", color: "#978F80", band: "Bottom 25%" };
    ...
    <div style={{ backgroundColor: "#F4F2EC", minHeight: "100vh", fontFamily: "var(--font-body, sans-serif)" }}>
      ...
      <header style={{ backgroundColor: "#F4F2EC", borderBottom: "1px solid #DDD9CF", padding: "0 24px" }}>
        <div style={{ maxWidth: "720px", margin: "0 auto", height: "64px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "20px" }}>
            <Link href="/blog" style={{ fontSize: "13px", color: "#3B35B5", fontWeight: 600, textDecoration: "none" }}>Blog</Link>
            <Link href="/test" style={{ backgroundColor: "#3B35B5", color: "#fff", padding: "8px 18px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
              Take the test →
            </Link>
          </div>
        </div>
      ...
      <main style={{ maxWidth: "720px", margin: "0 auto", padding: "48px 24px 80px" }}>
        ...
        <nav style={{ fontSize: "12px", color: "#978F80", marginBottom: "32px" }}>
          <Link href="/" style={{ color: "#978F80", textDecoration: "none" }}>Home</Link>
          <span style={{ margin: "0 8px" }}>›</span>
          <Link href="/iq-score/100" style={{ color: "#978F80", textDecoration: "none" }}>IQ Scores</Link>
          <span style={{ margin: "0 8px" }}>›</span>
          <span style={{ color: "#1C1B13" }}>IQ {iq}</span>
        </nav>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "16px", padding: "28px 32px", marginBottom: "16px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px" }}>
            <span style={{ fontSize: "13px", fontWeight: 600, color: "#1C1B13" }}>Position on the IQ scale</span>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "16px", padding: "32px", marginBottom: "16px" }}>
          ...
          {[
            ...
            <div key={row.range} style={{ display: "flex", justifyContent: "space-between", alignItems: "center", padding: "12px 16px", borderRadius: "8px", marginBottom: "4px", backgroundColor: row.current ? "#ECEBF8" : "transparent", border: row.current ? "1px solid #B9B8E4" : "1px solid transparent" }}>
              ...
              {row.current && <span style={{ marginLeft: "8px", fontSize: "11px", fontWeight: 700, color: "#3B35B5" }}>← You</span>}
            </div>
          ))}
        </div>
        ...
        <div style={{ backgroundColor: "#fff", border: "1px solid #DDD9CF", borderRadius: "16px", padding: "28px 32px", marginBottom: "32px" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
            {related.map(s => (
              <Link key={s} href={`/iq-score/${s}`} style={{ backgroundColor: "#F4F2EC", border: "1px solid #DDD9CF", color: "#3B35B5", padding: "8px 16px", borderRadius: "8px", fontSize: "13px", fontWeight: 600, textDecoration: "none" }}>
                IQ {s}
              </Link>
            ))}
          </div>
        ...
        <div style={{ backgroundColor: "#1C1B13", borderRadius: "16px", padding: "40px 32px", textAlign: "center" }}>
          ...
          <Link href="/test" style={{ display: "inline-block", backgroundColor: "#3B35B5", color: "#fff", padding: "16px 40px", borderRadius: "8px", fontSize: "15px", fontWeight: 600, textDecoration: "none" }}>
      ...
      {/* FOOTER */}
      <footer style={{ borderTop: "1px solid #DDD9CF", padding: "32px 24px", textAlign: "center" }}>
        <div style={{ display: "flex", justifyContent: "center", gap: "20px", marginBottom: "10px", flexWrap: "wrap" }}>
          ...
          <Link href={`/fr/iq-score/${iq}`} style={{ fontSize: "12px", color: "#978F80", textDecoration: "none" }}>Français</Link>
        </div>
        <p style={{ fontSize: "11px", color: "#B9B8E4" }}>© 2026 BrainScale · Not a clinical assessment</p>
      </footer>
    </div>
  );
}
